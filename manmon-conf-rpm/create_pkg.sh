...
if [ -f /home/manmon_conf/manmon-conf-${CONFNAME}-${VER}-${RELEASE}.noarch.rpm ]
then
...
cp -p /home/manmon_conf/.constants /home/mmagent/rpmbuild/SOURCES/
...
then 
  ...
  cp -p /home/mmagent/rpmbuild/RPMS/noarch/manmon-conf*.rpm /home/manmon_conf/
  echo "Package build succeeded - /home/manmon_conf/manmon-conf-${CONFNAME}-${VER}-${RELEASE}.noarch.rpm"
fi
